// VENDORED from alpha123/uma-skill-tools — do not edit by hand.
// Refresh with: node tools/sync-upstream-engine.mjs
import { CourseData } from '../uma-skill-tools-v1/CourseData';
import { Region, RegionList } from '../uma-skill-tools-v1/Region';
import { RaceParameters } from '../uma-skill-tools-v1/RaceParameters';
import { RaceSolver } from '../uma-skill-tools-v1/RaceSolver';
import { RaceSolverBuilder, Perspective } from '../uma-skill-tools-v1/RaceSolverBuilder';
import type { GameHpPolicy } from '../uma-skill-tools-v1/HpPolicy';
import { Rule30CARng } from '../uma-skill-tools-v1/Random';
import { ActivationSamplePolicy, ImmediatePolicy, RandomPolicy, LogNormalRandomPolicy, ErlangRandomPolicy, StraightRandomPolicy, AllCornerRandomPolicy } from '../uma-skill-tools-v1/ActivationSamplePolicy';
